...
export default props => {
  ...
  const userConfig = {
    ...{'name':'ant-design-pro','theme':'PRO','locale':true,'showBreadcrumb':true,'siderWidth':208,'navTheme':'dark','primaryColor':'#722ED1','layout':'side','contentWidth':'Fluid','fixedHeader':false,'fixSiderbar':true,'colorWeak':false,'title':'Mindstorm','pwa':false,'iconfontUrl':''},
    ...runtimeConfig || {}
  };
