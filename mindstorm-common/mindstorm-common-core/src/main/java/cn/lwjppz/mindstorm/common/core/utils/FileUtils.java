...
import cn.lwjppz.mindstorm.common.core.exception.ForbiddenException;
...
//        List<File> files = Arrays.asList(Objects.requireNonNull(targetDir.listFiles()));
...
//        }
    ...
    public static Path createTempDirectory() throws IOException {
        return Files.createTempDirectory("eternal");
    }
