...
public interface ProfessionService extends IService<Profession> {
    ...
    /**
     * 将 Profession 对象转为 SimpleProfessionDTO 对象
     *
     * @param profession Profession 对象
     * @return SimpleProfessionDTO 对象
     */
    SimpleProfessionDTO convertToSimpleProfessionDTO(Profession profession);

    /**
     * 将 Profession 集合转为 SimpleProfessionDTO 集合
     *
     * @param professions Profession 集合
